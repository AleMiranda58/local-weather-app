...
const getWeatherData = async () => {
    try {
      ...
      `https://api.openweathermap.org/data/3.0/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=515098059ca1d59b879a5af1ad232d8c&units=imperial`
    );
